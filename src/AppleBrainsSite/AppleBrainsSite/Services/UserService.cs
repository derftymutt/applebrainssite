using AppleBrainsSite.Classes.Exceptions;
using AppleBrainsSite.Models;
...
namespace AppleBrainsSite.Services
{
    public class UserService
    {
        ...
        public static IdentityUser CreateUser(string email, string password, string roleName = "Consumer")
        {
